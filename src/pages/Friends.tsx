  ...
  return (
    <main className="flex min-h-app flex-col bg-espresso text-secondary">
      <header className="px-4 pt-safe pt-4 pb-2">
        ...
        <p className="text-sm text-secondary/70">Share a sun spot with people you actually like.</p>
      </header>

      {!profile.handle && (
        <Card className="mx-4 mb-3 border-butter/40 bg-espresso-light p-4">
          <h2 className="mb-1 font-semibold">Pick your @handle</h2>
          <p className="mb-3 text-xs text-secondary/70">3–20 chars, lowercase, digits, underscore. Cannot be changed later.</p>
      ...
      <Tabs defaultValue="friends" className="flex-1 px-4">
        ...
        <TabsContent value="presence" className="space-y-4 py-3">
          {myPresence ? (
            <Card className="border-butter/30 bg-espresso-light p-4">
              <div className="text-sm text-secondary/70">You're live:</div>
              <div className="text-lg font-semibold">{myPresence.activity}</div>
              <div className="text-xs text-secondary/60">until {new Date(myPresence.expires_at).toLocaleTimeString()}</div>
          ...
          <section>
            <h3 className="mb-2 text-sm font-semibold uppercase tracking-wide text-secondary/60">Active friends</h3>
